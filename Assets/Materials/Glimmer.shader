Shader "Glimmer"
{
    Properties
    {
        ...
        _MetallicScalar("Metallic Scalar", Float) = 1
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            o.Albedo = albedo.rgb * _Color * (1 - abs(frac(_Time.y * (1/_Duration)) - 0.5));
            o.Alpha = albedo.a;

            o.Emission = emission.rgb * _EmissionColor * (1 + abs(frac(_Time.y * (1/_Duration)) - 0.5));
            
            o.Metallic = _Metallic * _MetallicScalar * IN.uv_Albedo.xy;
        ...
        Pass
        {
            ...
            {
                i.uv.x +=  _Time.x * _ScrollX;
                i.uv.y +=  _Time.x * _ScrollY;
